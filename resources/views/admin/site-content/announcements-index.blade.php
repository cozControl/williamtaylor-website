<x-admin.layout title="Announcements" description="Manage independently revisioned and scheduled storefront announcements." eyebrow="Content">
    <x-slot:actions>@can('announcements.create')<a class="admin-primary-button" href="{{ route('admin.content.announcements.create') }}">Create announcement</a>@endcan</x-slot:actions>
