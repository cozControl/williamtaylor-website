...
@section('route-bootstrap')
  <script>
   if (window.location.pathname === '/products/mercerized-cotton-polo') {
    const productReplaceState = History.prototype.replaceState;
    productReplaceState.call(window.history, window.history.state, '', '/product/mercerized-cotton-polo');
    window.addEventListener('load', function () {
     window.setTimeout(function () {
      productReplaceState.call(window.history, window.history.state, '', '/products/mercerized-cotton-polo');
      window.setTimeout(function () {
       ...
       <div class="grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-16">
        <div class="space-y-4">
         <div class="aspect-[3/4] overflow-hidden bg-gray-100 relative group">
          <img alt="Mercerized Cotton Polo" class="w-full h-full object-cover object-top" src="/website/images/db23eed31_image.jpg" style="opacity: 1;"/>
         </div>
         <div class="flex gap-3 overflow-x-auto scrollbar-hide">
          <button class="flex-shrink-0 w-20 h-24 overflow-hidden border-2 transition-all border-wt-gold">
           <img alt="Mercerized Cotton Polo 1" class="w-full h-full object-cover object-top" src="/website/images/db23eed31_image.jpg"/>
          </button>
          <button class="flex-shrink-0 w-20 h-24 overflow-hidden border-2 transition-all border-transparent hover:border-gray-300">
           <img alt="Mercerized Cotton Polo 2" class="w-full h-full object-cover object-top" src="/website/images/9c691e236_image.jpg"/>
          </button>
          <button class="flex-shrink-0 w-20 h-24 overflow-hidden border-2 transition-all border-transparent hover:border-gray-300">
           <img alt="Mercerized Cotton Polo 3" class="w-full h-full object-cover object-top" src="/website/images/b079734c1_image.jpg"/>
          </button>
          <button class="flex-shrink-0 w-20 h-24 overflow-hidden border-2 transition-all border-transparent hover:border-gray-300">
           <img alt="Mercerized Cotton Polo 4" class="w-full h-full object-cover object-top" src="/website/images/b9c0b1bdf_image.jpg"/>
          </button>
         </div>
        </div>
        <div class="space-y-6">
         ...
         <p class="font-body text-sm text-gray-600 font-light leading-relaxed">
          Oversized jacquard polo in mercerized cotton. An artistic print meets contemporary tailoring.
         </p>
         <div>
          ...
          <div class="flex gap-2">
           <button class="w-8 h-8 rounded-full border-2 transition-all border-wt-gold scale-110" style="background-color: rgb(196, 149, 106);" title="Camel">
           </button>
           <button class="w-8 h-8 rounded-full border-2 transition-all border-gray-200 hover:border-gray-400" style="background-color: rgb(212, 184, 150);" title="Sand">
           </button>
          </div>
         </div>
         <div>
       ...
       <div class="mt-20 border-t border-gray-100 pt-10">
        ...
        <div class="max-w-2xl">
         <div class="prose prose-sm max-w-none font-light text-gray-600">
          <p>
           The Mercerized Cotton Polo redefines casual luxury. Our oversized jacquard weave features a bold portrait-inspired print rendered in tonal earth hues — a wearable canvas.
          </p>
          <p>
           Mercerized for enhanced sheen and durability. The polo collar and relaxed hem make this equally at home on a rooftop terrace or a gallery opening.
          </p>
         </div>
        </div>
       </div>
