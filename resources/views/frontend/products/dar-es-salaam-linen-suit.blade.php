...
@section('route-bootstrap')
  <script>
   if (window.location.pathname === '/products/the-dar-es-salaam-linen-suit') {
    const productReplaceState = History.prototype.replaceState;
    productReplaceState.call(window.history, window.history.state, '', '/product/dar-es-salaam-linen-suit');
    window.addEventListener('load', function () {
     window.setTimeout(function () {
      productReplaceState.call(window.history, window.history.state, '', '/products/the-dar-es-salaam-linen-suit');
      window.setTimeout(function () {
       ...
       <div class="grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-16">
        <div class="space-y-4">
         <div class="aspect-[3/4] overflow-hidden bg-gray-100 relative group">
          <img alt="The Dar es Salaam Linen Suit" class="w-full h-full object-cover object-top" src="/website/images/da608a583_image.jpg" style="opacity: 1;"/>
         </div>
         <div class="flex gap-3 overflow-x-auto scrollbar-hide">
          <button class="flex-shrink-0 w-20 h-24 overflow-hidden border-2 transition-all border-wt-gold">
           <img alt="The Dar es Salaam Linen Suit 1" class="w-full h-full object-cover object-top" src="/website/images/da608a583_image.jpg"/>
          </button>
          <button class="flex-shrink-0 w-20 h-24 overflow-hidden border-2 transition-all border-transparent hover:border-gray-300">
           <img alt="The Dar es Salaam Linen Suit 2" class="w-full h-full object-cover object-top" src="/website/images/9c30daca8_image.jpg"/>
          </button>
          <button class="flex-shrink-0 w-20 h-24 overflow-hidden border-2 transition-all border-transparent hover:border-gray-300">
           <img alt="The Dar es Salaam Linen Suit 3" class="w-full h-full object-cover object-top" src="/website/images/b8589561c_image.jpg"/>
          </button>
          <button class="flex-shrink-0 w-20 h-24 overflow-hidden border-2 transition-all border-transparent hover:border-gray-300">
           <img alt="The Dar es Salaam Linen Suit 4" class="w-full h-full object-cover object-top" src="/website/images/84c5dcdc1_image.jpg"/>
          </button>
          <button class="flex-shrink-0 w-20 h-24 overflow-hidden border-2 transition-all border-transparent hover:border-gray-300">
           <img alt="The Dar es Salaam Linen Suit 5" class="w-full h-full object-cover object-top" src="/website/images/6e114010e_image.jpg"/>
          </button>
         </div>
        </div>
        <div class="space-y-6">
         ...
         <p class="font-body text-sm text-gray-600 font-light leading-relaxed">
          Our signature belted linen suit. Crafted for the Tanzanian climate, tailored for the global stage.
         </p>
         <div>
          ...
          <div class="flex flex-wrap gap-2">
           <button class="px-4 py-2 font-label text-xs border transition-all border-gray-200 text-gray-300 cursor-not-allowed line-through" disabled="">
            S
           </button>
         ...
         <div class="bg-red-50 border border-red-200 p-4">
          <div class="flex items-center gap-2 mb-2">
           <svg class="lucide lucide-circle-alert text-red-500" fill="none" height="14" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="2" viewbox="0 0 24 24" width="14" xmlns="http://www.w3.org/2000/svg">
           ...
           <p class="font-label text-[10px] tracking-wider uppercase text-red-600 font-semibold">
            Low Stock — Selling Fast
           </p>
          </div>
          <div class="w-full h-1.5 bg-red-100 rounded-full overflow-hidden">
           <div class="h-full bg-gradient-to-r from-red-400 to-red-600 rounded-full transition-all" style="width: 100%;">
           </div>
          </div>
          <p class="font-body text-xs text-red-500/70 font-light mt-2">
           Only 12 pieces remaining. Secure yours before it's gone.
          </p>
         </div>
         <div class="space-y-3">
       ...
       <div class="mt-20 border-t border-gray-100 pt-10">
        ...
        <div class="max-w-2xl">
         <div class="prose prose-sm max-w-none font-light text-gray-600">
          <p>
           The Dar es Salaam Linen Suit is our definitive statement piece. Named for the city that inspired William Taylor, this suit distills the energy of East Africa's most dynamic metropolis into wearable form.
          </p>
          <p>
           A relaxed double-breasted wrap silhouette with a self-tie belt — structured yet breathable, commanding yet effortless. The Belgian linen blend is pre-washed for softness and gains character with every wear.
          </p>
          <p>
           Only 30 pieces produced per season.
          </p>
         </div>
        </div>
       </div>
