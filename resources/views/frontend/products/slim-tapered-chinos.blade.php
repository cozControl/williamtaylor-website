...
@section('route-bootstrap')
  <script>
   if (window.location.pathname === '/products/slim-tapered-chinos') {
    const productReplaceState = History.prototype.replaceState;
    productReplaceState.call(window.history, window.history.state, '', '/product/slim-tapered-chinos');
       ...
       <div class="grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-16">
        <div class="space-y-4">
         <div class="aspect-[3/4] overflow-hidden bg-gray-100 relative group">
          <img alt="Slim Tapered Chinos" class="w-full h-full object-cover object-top" src="/website/images/8d7122778_image.jpg" style="opacity: 1;"/>
         </div>
         <div class="flex gap-3 overflow-x-auto scrollbar-hide">
          <button class="flex-shrink-0 w-20 h-24 overflow-hidden border-2 transition-all border-wt-gold">
           <img alt="Slim Tapered Chinos 1" class="w-full h-full object-cover object-top" src="/website/images/8d7122778_image.jpg"/>
          </button>
          <button class="flex-shrink-0 w-20 h-24 overflow-hidden border-2 transition-all border-transparent hover:border-gray-300">
           <img alt="Slim Tapered Chinos 2" class="w-full h-full object-cover object-top" src="/website/images/c37b38a71_image.jpg"/>
          </button>
          <button class="flex-shrink-0 w-20 h-24 overflow-hidden border-2 transition-all border-transparent hover:border-gray-300">
           <img alt="Slim Tapered Chinos 3" class="w-full h-full object-cover object-top" src="/website/images/601f1442e_image.jpg"/>
          </button>
          <button class="flex-shrink-0 w-20 h-24 overflow-hidden border-2 transition-all border-transparent hover:border-gray-300">
           <img alt="Slim Tapered Chinos 4" class="w-full h-full object-cover object-top" src="/website/images/ebe8fd1d1_image.jpg"/>
          </button>
         </div>
        </div>
        <div class="space-y-6">
         ...
         <p class="font-body text-sm text-gray-600 font-light leading-relaxed">
          Fluid wide-leg trousers in satin-finish fabric. The modern gentleman's essential bottom.
         </p>
         <div>
          ...
          <div class="flex gap-2">
           <button class="w-8 h-8 rounded-full border-2 transition-all border-wt-gold scale-110" style="background-color: rgb(143, 169, 138);" title="Sage">
           </button>
           <button class="w-8 h-8 rounded-full border-2 transition-all border-gray-200 hover:border-gray-400" style="background-color: rgb(245, 237, 214);" title="Cream">
           </button>
          </div>
         </div>
         <div>
       ...
       <div class="mt-20 border-t border-gray-100 pt-10">
        ...
        <div class="max-w-2xl">
         <div class="prose prose-sm max-w-none font-light text-gray-600">
          <p>
           The Slim Tapered Chinos redefine what a trouser can be. A generous wide-leg silhouette cut from fluid satin-finish fabric creates movement with every step — structured at the high waist with double pleats, cascading to a clean hem.
          </p>
          <p>
           Available in our signature Sage and Cream colourways, both developed to pair seamlessly across the William Taylor wardrobe.
          </p>
         </div>
        </div>
       </div>
