...
@section('route-bootstrap')
  <script>
   if (window.location.pathname === '/products/the-taylor-oxford-shirt') {
    ...
    productReplaceState.call(window.history, window.history.state, '', '/product/taylor-oxford-shirt');
        ...
        <div class="max-w-2xl">
         <div class="prose prose-sm max-w-none font-light text-gray-600">
          ...
          <p>
           ...
           100% Italian textured cotton. Breathable, structured, and pre-washed for an immediate softness.
           <strong>
            The Fit:
           </strong>
           Boxy and relaxed. Model is 6'1" wearing size M.
           <strong>
            The Detail:
           </strong>
