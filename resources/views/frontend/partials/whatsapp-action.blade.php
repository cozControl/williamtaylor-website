    <a aria-label="Chat on WhatsApp" class="fixed bottom-20 lg:bottom-6 right-4 lg:right-6 z-30 w-12 h-12 lg:w-14 lg:h-14 bg-wt-gold shadow-xl flex items-center justify-center hover:bg-wt-oxblood transition-colors duration-300 group" href="{{ $publicSiteChrome?->profile?->whatsApp ? 'https://wa.me/'.preg_replace('/\D+/', '', $publicSiteChrome->profile->whatsApp) : 'https://wa.me/255656464876?text=Hello%20William%20Taylor%2C%20I%20have%20an%20enquiry.' }}" rel="noopener noreferrer" target="_blank">
