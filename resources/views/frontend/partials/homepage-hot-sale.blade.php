<section data-homepage-hot-sale class="py-12 lg:py-20 bg-white">
    <div class="max-w-screen-xl mx-auto px-4 lg:px-12">
        ...
        <div class="grid grid-cols-1 md:grid-cols-3 gap-4">
            @foreach ($homepageHotSale['tiles'] as $tile)
                <article data-hot-sale-tile class="group relative overflow-hidden aspect-[3/4] cursor-pointer" style="opacity: 1; transform: none;">
                    <a href="{{ $tile['url'] }}">
                        ...
                        <div class="absolute inset-0 flex flex-col items-center justify-end p-4 lg:p-6 text-center">
                            <div class="group-hover:-translate-y-2 transition-transform duration-300">
                                ...
                                <p class="font-body text-xs lg:text-sm text-wt-cream/70 font-light mb-3 opacity-0 group-hover:opacity-100 transition-opacity duration-300">{{ $tile['copy'] }}</p>
