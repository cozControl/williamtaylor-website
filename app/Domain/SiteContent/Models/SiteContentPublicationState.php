...
/**
 * @property string $id
 * @property string $site_content_id
 ...
 */ final class SiteContentPublicationState extends Model
{
    use HasUlids;
    ...
    /** @return HasMany<SiteContentPublicationTransition, $this> */
    public function transitions(): HasMany
    {
        return $this->hasMany(SiteContentPublicationTransition::class, 'publication_state_id');
    }
}
