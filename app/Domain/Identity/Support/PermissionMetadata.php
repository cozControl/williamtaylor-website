...
final class PermissionMetadata
{
    ...
    public static function all(): array
    {
        return [
            ...
            PermissionRegistry::PRODUCTS_VIEW => ['label' => 'View products', 'area' => 'Catalogue', 'description' => 'Inspect canonical Products and catalogue configuration.'],
            PermissionRegistry::PRODUCTS_MANAGE => ['label' => 'Manage products', 'area' => 'Catalogue', 'description' => 'Manage canonical Products, Collections and Campaigns.'],
            PermissionRegistry::INVENTORY_VIEW => ['label' => 'View inventory', 'area' => 'Inventory', 'description' => 'Inspect Variant stock and movement history.'],
            PermissionRegistry::INVENTORY_MANAGE => ['label' => 'Manage inventory', 'area' => 'Inventory', 'description' => 'Record authorized Variant stock movements through the inventory ledger.'],
            ...
            PermissionRegistry::ORDERS_VIEW => ['label' => 'View Orders', 'area' => 'Order operations', 'description' => 'Inspect production customer Orders, contact and delivery snapshots, and check existing payment Sessions. Also permits isolated demo viewing when demo mode is configured.'],
            ...
            PermissionRegistry::ORDERS_CANCEL => ['label' => 'Cancel Orders', 'area' => 'Order operations', 'description' => 'Cancel eligible unpaid production Orders with a reason and verified payment finality. Also permits existing isolated demo cancellation.'],
