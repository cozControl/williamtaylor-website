...
final class AdminNavigationRegistry
{
    ...
    public function all(): array
    {
        return [
            ...
            new AdminNavigationItem('homepage', 'Homepage', 'admin.homepage.edit', PermissionRegistry::SETTINGS_VIEW, 'Website', 30, 2, 'Manage the storefront Homepage Hero.', 'home', 'admin.homepage.*'),
            ...
            new AdminNavigationItem('catalogue', 'Catalogue', 'admin.catalogue.index', PermissionRegistry::PRODUCTS_VIEW, 'Catalogue', 20, 5, 'Catalogue overview and readiness.', 'catalogue', 'admin.catalogue.*'),
